...
export default function AdminDashboard() {
  ...
  const widgets = [
    ...
    { label: 'Pending Review', value: stats?.pendingListings || 0, color: 'bg-primary/10 text-primary', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
    { label: 'Approved', value: stats?.approvedListings || 0, color: 'bg-primary/10 text-primary', icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z' },

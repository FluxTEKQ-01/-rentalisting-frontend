                ...
                <div className="flex flex-wrap gap-6 py-5 border-y border-[#E2E8F0] mb-6">
                  ...
                  {property.area > 0 && (
                    <div className="text-center">
                      ...
                      <p className="text-xs text-neutral-700/60 mt-0.5">{property.areaUnit || 'sq ft'}</p>
                    </div>
                  )}
                </div>
              )}
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
            <Card className="p-6">
              <div className="flex items-center justify-between gap-2 mb-4">
                <div>
                  <h2 className="font-display text-lg font-bold text-primary">Location Map</h2>
                ...
                <a
                  ...
                  className="text-xs font-semibold text-primary hover:underline flex items-center gap-1 bg-primary/5 hover:bg-primary/10 px-3 py-1.5 rounded-lg border border-primary/10 transition-colors shrink-0"
                >
                  <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="h-[300px] rounded-2xl overflow-hidden border border-slate-200 shadow-inner relative [&_.leaflet-container]:rounded-[inherit]">
                <MapContainer
                  center={coords}
                  zoom={14}
                ...
                >
                  ...
                  <Marker position={coords}>
                    <Popup>
                      <div className="font-medium text-xs text-slate-900 p-0.5">
                        <strong className="text-primary font-bold">{property.title}</strong>
                        <br />
                        <span className="text-slate-600">{property.location.address}, {property.location.city} {property.location.zipCode}</span>
                      </div>
                    </Popup>
                  </Marker>
                </MapContainer>
